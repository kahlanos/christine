        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../categorias" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Categorías</a>
        ...
        <div class="content">
            ...
            <div class="col-12 col-xl-6 container-fluid">
                <div class="bg-secondary rounded h-100 p-4 m-4">
                    <h6 class="mb-4">Nueva categoría</h6>
                    
                    <form action="add/process" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre</label>
                            <input name="nombre" type="text" class="form-control" id="nombre" value="" maxlength="30" required>                           
                        </div>
                        <div class="mb-3">
                            <label for="descripcion" class="form-label">Descripcion</label>
                            <input name="descripcion" type="text" class="form-control" id="descripcion" value="" maxlength="100" required>                           
                        </div>
                        <div class="mb-3">
                            <label for="imagen" class="form-label">Imagen</label>
                            <input name="imagen" type="file" class="form-control form-control bg-dark" id="imagen" value="">
                        </div>           
                        <div class="mb-3">
                            <label for="categoria" class="form-label">Categoría Padre</label>
                            
                            <select id="categorias" name="padre" class="form-select form-select mb-3">
                                <option>N/A</option>
                            </select>
                        </div>
                        
                        <button type="submit" class="btn btn-outline-success m-2">Guardar</button>
                        <a class="btn btn-outline-primary m-2" href="../categorias" role="button">Cancelar</a>                    
                    </form>
                </div>
            </div>
