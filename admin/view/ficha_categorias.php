        ...
        <div class="content">
            ...
            <div class="col-12 col-xl-6 container-fluid">
                <div class="bg-secondary rounded h-100 p-4 m-4">
                    <h6 class="mb-4">Edición de categoría</h6>
                    ...
                    <form action= "<?php echo $id?>/process" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="imagen" type="file" class="form-control form-control bg-dark" id="imagen" value="<?php echo $res->getImagen()?>">
                            <div class="m-3">
                            <?php 
                            $img = $res->getImagen(); 
                            if ($img != "" && $img != NULL && $img != 'NULL') {
                                echo "<img src='../../img/img_cat/$id/$img' style='width:100px;height: 100px;' class='rounded-3'></img> ";
                            }
                            ?> 
                            </div>                         
                        </div>           
                        <div class="mb-3">
                            ...
                            <select id="categorias" name="padre" class="form-select form-select mb-3" require>
                                <option><?php echo $res->getPadre()?></option>
                                <option>----------------------------</option>
                            </select>
                        </div>
