...
<body>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div id="paginacion" class="bg-secondary rounded float-right">
                    <div>
                    <a class="btn btn-outline-success ms-4" href="categorias/add" role="button"><i class="fa fa-user-plus"></i></a>
                    </div>
                    <div class="float-right me-4" style="text-align: right;">
                    <button type="button" class="btn btn-square btn-outline-info m-2"><i class="fa fa-backward"></i></button>
                    <button type="button" class="btn btn-square btn-outline-info m-2"><i class="fa fa-forward"></i></button>
                    </div>
                </div>
            </div>
            <!-- Table End -->
    ...
    <script src="../template/js/categorias.js"></script>
</body>
<footer>
    <!-- Footer Start -->
    <div class="container-fluid pt-4 px-4">
