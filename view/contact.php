    ...
    <div class="col-12 row m-5">
      ...
      <form>
        ...
        <textarea class="form-control" id="textAreaExample" rows="4"></textarea>
          <label class="form-label text-white-50" for="form6Example4">Tu mensaje</label>
        </div>

        <!-- Crear cuenta button -->
        <button type="button" class="btn btn-primary btn-rounded me-4" id="boton">Enviar</button>
